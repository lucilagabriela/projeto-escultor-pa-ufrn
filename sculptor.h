...
public: // metodos:
  ...
  void putSphere(int xcenter, int ycenter, int zcenter, int radius); // cria esfera
  void cutSphere(int xcenter, int ycenter, int zcenter, int radius); // apaga esfera
  void putEllipsoid(int xcenter, int ycenter, int zcenter, int rx, int ry, int rz); // cria elipse
  void cutEllipsoid(int xcenter, int ycenter, int zcenter, int rx, int ry, int rz); // apaga elipse
